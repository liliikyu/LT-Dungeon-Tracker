    ...
    $("dungeon-grid").innerHTML = visible.map((dungeon) => {
      ...
      const achievementSectionHtml = achievements.length ? `<section class="dungeon-achievement-section">
        <div class="dungeon-achievement-head">
          <div class="dungeon-achievement-title"><span class="achievement-trophy" aria-hidden="true">🏆</span><strong>Achievement</strong><span class="achievement-count">${achievements.length}</span></div>
          <a class="achievement-wiki-link" href="https://latale.wiki.gg/wiki/Achievement" target="_blank" rel="noopener noreferrer">View on Wiki ↗</a>
        </div>
        <div class="dungeon-achievement-list">${achievements.map((achievement) => `<div class="dungeon-achievement-row">
          <div class="dungeon-achievement-copy">
            <a class="dungeon-achievement-name" href="https://latale.wiki.gg/wiki/Achievement" target="_blank" rel="noopener noreferrer">${esc(achievement.name)}</a>
      ...
      const cardContentHtml = `
        ...
        ${monsterSummaryHtml}
        ${summaryHtml}
        ${isExpandable ? `<div class="dungeon-body">${monsterSectionHtml}${uniqueLootSectionHtml}${achievementSectionHtml}${columnsHtml}<section class="dungeon-conquest-placeholder"><div class="dungeon-conquest-placeholder-head"><strong>Dungeon Conquest</strong><span class="coming-soon-badge">Coming Soon</span></div></section></div>` : ""}
        ${titleNote}
      `;
