  ...
  function render() {
    ...
    $("dungeon-grid").innerHTML = visible.map((dungeon) => {
      ...
      const renderFlags = (item) => [
        ...
        item.awakeningQuesting ? '<span class="flag awakening-questing" title="Used for Awakening Questing">Awakening Questing</span>' : "",
        item.legendQuesting ? '<span class="flag legend-questing" title="Worth keeping for Legend Questing">Legend Questing</span>' : ""
      ].join("");
