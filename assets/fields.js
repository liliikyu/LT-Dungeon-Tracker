(() => {
  ...
  function render(){
    ...
    const visible=entries.filter(f=>{
      ...
      return !q||[f.name,...f.illustrations,...f.codex.map(codexName)].join(" ").toLowerCase().includes(q);
    });
