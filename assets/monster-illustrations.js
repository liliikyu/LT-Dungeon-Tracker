window.LT_MONSTER_ILLUSTRATIONS = {
  ...
  "dungeons": {
    ...
    "World's Genesis": [
      ...
      "Yggdrasil Halberd Einherjar",
      "Yggdrasil Sharp Einherjar",
      "Yggdrasil Axe Einherjar",
      "Hraesvelgr",
      "Verdrfolnir"
    ],
    "Big Tube": [
    ...
    "Purgatory Azreal": [
      ...
      "Samael of Trust",
      "Red Beaked Harab",
      "Gha'agsheblah of Greed",
      "Gha'agsheblah of Stupor",
      "Thamiel",
      "Vice The Sinner"
    ],
    "Chronos' Time": [
    ...
    "Mushroom Swamp": [
      "Sylphin of the South",
      "Sylphin of the North",
      "Blue Berserker",
      "Poison Berserker",
      "Tired Agoste",
      "Crazy Agoste",
    ...
    "Eroded Arcane Hall": [
      "Magistrate Owl Wizard",
      "Veteran Owl Wizard",
      "Master Owl Wizard",
      "Darkness Book Golem",
      "Holy Book Golem",
      "Lab 1 Magic Researcher",
      "Lab 2 Magic Researcher",
      "Lab 3 Magic Researcher",
      "Ego Notoria"
    ],
    "Pseudaria": [
      "Raudskinna",
    ...
    "Helepol Fort": [
      ...
      "Crocro",
      "Cricri",
      "Brave Puriring Colossus",
      "Extraordinary Puriring Colossus",
      "Strong Puriring Colossus",
      "Boring Decarabi",
      "Tired Decarabi"
    ],
    "Trial of Iron": [
    ...
    "Wings of Icarus": [
      ...
      "Cera-Alba No.9",
      "Loyal Devil Knight",
      "Stalwart Devil Knight",
      "Demon Lord Albino Goblin",
      "Overlord Albino Goblin",
      "Iron Lord Albino Goblin",
      "Creed Soldier of Oblivion",
    ...
    "Nest of the Blind Bird": [
      ...
      "Sapphire Strange Bird",
      "Diamond Strange Bird",
      "Brown Rock Troll",
      "Black Roll Troll",
      "Debesys Jewel Troll",
